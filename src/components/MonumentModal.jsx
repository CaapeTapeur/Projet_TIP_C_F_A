          ...
          <div className="p-8 max-h-96 overflow-y-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="flex items-start space-x-2">
                ...
                <div>
                  <p className="font-semibold">{t('monuments.info.hours')}</p>
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  <p className="font-semibold">{t('monuments.info.price')}</p>
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  <p className="font-semibold">{t('monuments.info.access')}</p>
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-bold mb-2 text-red-900">
                  {t('monuments.info.history')}
                </h3>
                <p className="text-gray-700 leading-relaxed">
                  {t(`monuments.monuments.${monument.id}.history`)}
                </p>
              </div>

              <div>
                <h3 className="text-xl font-bold mb-2 text-red-900">
                  {t('monuments.info.anecdotes')}
                </h3>
                <p className="text-gray-700 leading-relaxed">
                  {t(`monuments.monuments.${monument.id}.facts`)}
                </p>
              </div>
            </div>
          </div>
